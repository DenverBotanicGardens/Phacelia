...
ph1 <- phall[popNames(phall) != "T"]
# Where are the individual information kept, which numbered individuals are kept? Maybe I dont' want? I want to see by distance among populaitons and with populaitons is the genetic distance compared to one spatial distance? Can't get genetic diversity Fst or whatnot from individuals, need the whole 'populaiton' 

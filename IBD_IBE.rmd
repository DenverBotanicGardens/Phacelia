...
#instead of varespec will have bioph ## But I've got negative values so this isn't quite right
# not the same, varespec are the species in each community, bioph is the bioclim per popuation
bioph <- sdmdata[cnts!="0",-(1:3)]
bioph.dis <- vegdist(bioph)
vare.mds0 <- isoMDS(bioph.dis)

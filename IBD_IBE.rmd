...
#same grid as bioclim, create raster, r, same extent of bioclim.phfo[[1]]
#Make spatialpointsdataframe

background.crop <- crop(bioclim.phfo[[1]], extent(polygons(x)), snap="out",
                        filename="Q:/Research/All_Projects_by_Species/Phacelia SPECIES/Phacelia_formosula/Phacelia formosula_abiotic/Maps/bc_bg_phfo_1")

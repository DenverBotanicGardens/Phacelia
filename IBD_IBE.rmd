...
```{r}
# create background points for convex haul for all three
...
phfo.spdf <- phfo.UTM[,c("lon","lat")]
coordinates(phfo.spdf) <- ~lon+lat
crs(phfo.spdf) <- crs(bioclim.phfo[[1]])

r <- raster()
r <- res(bioclim.phfo[[1]])
bgd <- 

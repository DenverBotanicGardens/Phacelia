...
# points(phfo.LatLon, pch=16)
segments(-106.6,40.25,-106.6,41, lwd=2)
segments(-105.05,40.25,-105.05,41, lwd=2)
segments(-106.6,40.25,-105.05,40.25, lwd=2)
segments(-106.6,41,-105.05,41, lwd=2)
...
xSPDF <- circles(phfo.UTM1[,c("Easting","Northing")], d=5000, lonlat=FALSE)
pntSPDF <- spsample(polygons(xSPDF), n=300, "stratified")

plot(xSPDF)
points(pntSPDF, pch=16, col="blue")

...
```{r}
boxplot(distgenEUCL,distgenDIFF,distgenDiSS,dist.genpop(phall.genepop,method=2)) #the last is among populaitons, not individuals
```
...
plot(phall$other$xy, pch=temp, cex=1.5) #looks wrong somehow...

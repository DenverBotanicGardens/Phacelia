---
title: "Gompert and Buerkle hybrids"
...
sam.parentals<- function(afreq,nparind){
  nloci <- dim(afreq)[1]
  # genotypes
  par0.g<-array(dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy"))
  par1.g<-array(dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy"))
  F1.g<-array(dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy"))
  ...
  # ancestries
  par0.a<-array(data=0,dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy"))
  par1.a<-array(data=1,dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy"))
  F1.a<-array(dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy"))
  F1.a[,,1]<- par0.a[,,1]
  F1.a[,,2]<- par1.a[,,1]
...
make.nextgen<- function(parent1, parent2, parent1anc, parent2anc, nparind, map){
  ...
  nloci <- dim(parent1)[1]
  off.g<-array(dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy")) # genotype
  off.a<-array(dim=c(nloci,nparind,2))#,dimnames=c("locus","ind","copy")) # ancestry

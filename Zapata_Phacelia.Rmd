...
pairs(phfocc[,-(1:7)]) #plant height and width are phfocc[,8:9]
cor(phfocc[,-(1:7)])
...
ggplot(pa.xy, aes(PC1, PC2, colour = Population.Code))+
  geom_point()+
  stat_ellipse()+
  theme_bw()
...
#  geom_path(data=ridge, aes(d.1., d.2., colour=site))+
  theme_bw()
...
for(i in 1:length(df)){
  ...
  print(ggplot()+
    ...
    theme_bw()+
    geom_path(data=ridge_site, aes(d.1., d.2., colour=site))+
    stat_ellipse(data=phfocc_site, aes(PC1,PC2,colour=Population.Code), linetype=3)+
    stat_ellipse(data=phfocc_site, aes(PC1,PC2,colour=Population.Code), level=0.85, linetype=3)+
    stat_ellipse(data=phfocc_site, aes(PC1,PC2,colour=Population.Code), level=0.75, linetype=3))
}
...
ggplot(toleranceell, aes(colour = site))+
  geom_line(aes(alfa, beta_vector_SPA), col = "red")+
  geom_line(aes(alfa, beta_vector_SPB), col = "purple")+
  facet_grid(~site)+
  theme_bw()+

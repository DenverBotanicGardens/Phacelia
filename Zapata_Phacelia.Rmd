...
pairs(phfocc_noTC[,-(1:7)]) #plant height and width are phfocc[,8:9]
cor(phfocc_noTC[,-(1:7)])

names(phfocc_noTC[,-(1:7),])

pa_noTC <- pca(phfocc_noTC[,-(1:7)], cor = TRUE)
...
ggplot(phfocc_noTC, aes(PC1, PC2, colour = Population.Code))+
  geom_point()+
  stat_ellipse()+
  theme_bw()
...
ggplot()+
  ...
  geom_path(data=ridge, aes(d.1., d.2., colour=site), linetype=3)+
  theme_bw()
